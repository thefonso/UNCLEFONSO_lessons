...
# need to use a different tool. For that we will use Rack.
# Rack is the interface tool that allows our Sinatra application 
# to talk to the server. This is what almost all Ruby web hosting
# sites use, because it allows the host to present one interface 
# that all frameworks will meet.
