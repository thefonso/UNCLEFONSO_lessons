...
1.0.class                           # => Float
"abc".class                         # => String
thefonso.class                        # => Person
thefonso.birthday.class               # => Date
...
thefonso.instance_variables           # => ["@birthday", "@age", "@name"]
thefonso.birthday.instance_variables  # => ["@sg", "@of", "@ajd"]

# what methods does the object have?
thefonso.methods                      # => ["inspect", "tap", "birthday=", "clone", "public_methods", "object_id", "__send__", "instance_variable_defined?", "equal?", "freeze", "extend", "send", "methods", "hash", "dup", "to_enum", "instance_variables", "eql?", "instance_eval", "id", "singleton_methods", "taint", "frozen?", "instance_variable_get", "enum_for", "instance_of?", "display", "to_a", "method", "type", "instance_exec", "protected_methods", "==", "===", "instance_variable_set", "kind_of?", "respond_to?", "to_s", "class", "__id__", "tainted?", "=~", "private_methods", "untaint", "nil?", "is_a?", "birthday"]
thefonso.methods.grep(/birthday/)     # => ["birthday=", "birthday"]
